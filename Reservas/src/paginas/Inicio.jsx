        ...
        <div className="rown medium-unstack">
          <div className="columns">
            ...
            <p className="marketing-site-three-up-desc">
              ¡Experimenta la adrenalina en nuestra cancha de paintball! Reserva
              tu espacio y prepárate para una batalla llena de estrategia y
              emoción. Atrévete a vivir una experiencia única en un campo de
              paintball diseñado para la diversión extrema.
            </p>
          </div>
          <div className="columns">
            ...
            <br />
            <p className="marketing-site-three-up-desc">
              Reserva nuestra cancha de fútbol y disfruta de partidos
              emocionantes con tus amigos. Ya sea un juego casual o un torneo,
              ¡nuestra cancha es perfecta para que vivas la pasión del fútbol!
            </p>
          </div>
          <div className="columns">
            ...
            <br />
            <p className="marketing-site-three-up-desc">
              Ven a disfrutar del voleibol en nuestra cancha. Reúne a tu equipo
              y disfruta de partidos emocionantes. Nuestra cancha te ofrece el
              espacio perfecto para competir y divertirte.
            </p>
          </div>
        </div>
      </section>
