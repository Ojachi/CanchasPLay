...
const Canchas = () => {
  return (
    <div className='contenedorCanchas'>
      ...
      <h3 className='textoCan'>¡Siente la emoción del fútbol en nuestra cancha de calidad profesional! Reserva tu espacio y disfruta de partidos llenos de acción en un entorno espectacular.</h3>
      <Carrousel images={[futbol1, futbol2, futbol3]} />
      <div style={{ margin: '10px 0' }}></div>
      <h1 className='textoCan1_1'>Voleibol</h1>
      <h3 className='textoCan1'>Nuestra cancha de voleibol te espera para partidos emocionantes. Experimenta la diversión y la competencia en un ambiente soleado y amigable. ¡Reserva ahora!</h3>
